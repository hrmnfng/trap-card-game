...
This project is indexed by GitNexus as **trap-card-game** (909 symbols, 1631 relationships, 53 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
