...
This project is indexed by GitNexus as **trap-card-game** (1446 symbols, 2402 relationships, 65 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
